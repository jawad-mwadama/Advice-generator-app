  ...
  return (
    <>
      {error ? (
        ...
        <main className="relative mx-3 max-w-sm rounded-2xl bg-slate-700 p-7 text-center sm:mx-4 sm:max-w-md md:mx-4.5">
          <h5 className="font-light tracking-wider text-emerald-300">
            Advice #{advice.id}
          </h5>

          <div className="">
            <h6 className="py-3 text-2xl font-bold text-sky-200">
          ...
          <div
            className="absolute -bottom-5 left-1/2 mt-2 flex -translate-x-1/2 items-center justify-center rounded-full bg-emerald-300 sm:-bottom-6 md:-bottom-6"
            onClick={fetchAdvice}
            disabled={isLoading}
          >
